...
class RFLinkRawToolsPanel extends HTMLElement {
  ...
  async _loadAll(render=true){await this._loadStatus(render);if(this._state.tab==="captured")await this._loadCaptured(false);}
  ...
  _setTab(t){this._state.tab=t;localStorage.setItem("rflink_raw_tools.tab",t);this._state.error="";this._state.message="";this._update();if(t==="captured")this._loadCaptured();}
