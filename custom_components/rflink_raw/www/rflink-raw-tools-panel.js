const APP_BUILD_ID = "v002-config-overview-hacs-fix-20260517";
...
class RFLinkRawToolsPanel extends HTMLElement {
  ...
  _configurationView() {
    ...
    return `<section class="addon-card config-page">
      <div class="config-hero"><div><h2>Configuration</h2><p class="desc tight">Switches and maintenance actions for RFLink YAML, sidebar placement, Overview dashboard card, and alias-backed Home Assistant switches.</p></div><button class="secondary" data-action="_checkSetup">Check setup</button></div>
