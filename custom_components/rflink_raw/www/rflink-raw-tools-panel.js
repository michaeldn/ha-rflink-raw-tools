const APP_BUILD_ID = "v004-hacs-readme-logo-20260517";
  ...
  _configurationView() {
    ...
    return `<section class="addon-card config-page">
      ...
      <div class="config-grid improved">
        ...
        <div class="config-box placement-box"><h3>App placement</h3><div class="option-line"><div><b>Show in left sidebar</b><span>Turn off only if you plan to open <code>/rflink-raw-tools</code> directly.</span></div><label class="switch"><input type="checkbox" data-option-toggle="sidebar_enabled" ${o.sidebar_enabled ? "checked" : ""}><span class="slider"></span></label></div><div class="overview-card-block"><div><b>Dashboard shortcut</b><span>RFLink Raw Tools is already available in the left sidebar. To add a dashboard shortcut, copy this button card and paste it into a Manual card on any dashboard. RFLink Raw Tools does not edit Overview automatically in v0.0.4.</span></div><pre class="dashboard-yaml">type: button
name: RFLink Raw Tools
icon: mdi:radio-tower
show_name: true
show_icon: true
