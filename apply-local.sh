...
ZIP="/Users/michaeldumas/Downloads/ha-rflink-raw-tools-v0.0.1-dashboard-optional-entities-onefile.zip"
EXTRACT="/Users/michaeldumas/Downloads/ha-rflink-raw-tools-v0.0.1-dashboard-optional-entities-extract"
...
git add .
git commit -m "Treat optional dashboard entities as optional" || true
