...
ZIP="/Users/michaeldumas/Downloads/ha-rflink-raw-tools-v0.0.1-dynamic-dashboard-fix-onefile.zip"
EXTRACT="/Users/michaeldumas/Downloads/ha-rflink-raw-tools-v0.0.1-dynamic-dashboard-fix-extract"
...
git add .
git commit -m "Rebuild RFLink dashboard from entity registry" || true
