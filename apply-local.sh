...
ZIP="/Users/michaeldumas/Downloads/ha-rflink-raw-tools-v0.0.1-async-update-fix-onefile.zip"
EXTRACT="/Users/michaeldumas/Downloads/ha-rflink-raw-tools-v0.0.1-async-update-fix-extract"
...
git add .
git commit -m "Run RFLink updater outside the event loop" || true
