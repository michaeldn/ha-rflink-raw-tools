...
ZIP="/Users/michaeldumas/Downloads/ha-rflink-raw-tools-v0.0.1-update-status-ui-onefile.zip"
EXTRACT="/Users/michaeldumas/Downloads/ha-rflink-raw-tools-v0.0.1-update-status-ui-extract"
...
git add .
git commit -m "Add RFLink update status and progress UI" || true
