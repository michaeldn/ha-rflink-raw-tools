...
ZIP="/Users/michaeldumas/Downloads/ha-rflink-raw-tools-v0.0.1-dashboard-mode-fix-onefile.zip"
EXTRACT="/Users/michaeldumas/Downloads/ha-rflink-raw-tools-v0.0.1-dashboard-mode-fix-extract"
...
git add .
git commit -m "Fix RFLink dashboard sidebar registration mode" || true
