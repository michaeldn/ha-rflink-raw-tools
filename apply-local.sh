...
ZIP="/Users/michaeldumas/Downloads/ha-rflink-raw-tools-v0.0.1-setup-return-fix-onefile.zip"
EXTRACT="/Users/michaeldumas/Downloads/ha-rflink-raw-tools-v0.0.1-setup-return-fix-extract"
...
git add .
git commit -m "Fix RFLink Raw Tools setup return value" || true
