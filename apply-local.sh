...
ZIP="/Users/michaeldumas/Downloads/ha-rflink-raw-tools-v0.0.1-app-setup-return-final-fix-onefile.zip"
EXTRACT="/Users/michaeldumas/Downloads/ha-rflink-raw-tools-v0.0.1-app-setup-return-final-fix-extract"
...
git status --short
git add .
git commit -m "Fix RFLink app async setup structure" || true
