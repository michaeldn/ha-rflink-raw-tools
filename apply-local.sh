...
ZIP="/Users/michaeldumas/Downloads/ha-rflink-raw-tools-v0.0.1-reset-and-progress-fix-onefile.zip"
EXTRACT="/Users/michaeldumas/Downloads/ha-rflink-raw-tools-v0.0.1-reset-and-progress-fix-extract"
...
git add .
git commit -m "Fix RFLink reset UI and update progress status" || true
