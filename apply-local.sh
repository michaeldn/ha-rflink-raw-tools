...
ZIP="/Users/michaeldumas/Downloads/ha-rflink-raw-tools-v0.0.1-action-prereq-fix-onefile.zip"
EXTRACT="/Users/michaeldumas/Downloads/ha-rflink-raw-tools-v0.0.1-action-prereq-fix-extract"
...
git add .
git commit -m "Fix RFLink actions and prerequisite detection" || true
