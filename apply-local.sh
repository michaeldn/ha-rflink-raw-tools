...
ZIP="/Users/michaeldumas/Downloads/ha-rflink-raw-tools-v0.0.1-captured-raw-fix-onefile.zip"
EXTRACT="/Users/michaeldumas/Downloads/ha-rflink-raw-tools-v0.0.1-captured-raw-fix-extract"
...
git status --short
git add -A
git commit -m "Show raw RFLink captures and command candidates" || true
