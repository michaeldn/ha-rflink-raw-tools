...
ZIP="/Users/michaeldumas/Downloads/ha-rflink-raw-tools-v0.0.1-helpful-tool-rebuild-onefile.zip"
EXTRACT="/Users/michaeldumas/Downloads/ha-rflink-raw-tools-v0.0.1-helpful-tool-rebuild-extract"
...
git status --short
git add -A
git commit -m "Rebuild RFLink Raw Tools as helpful capture tool" || true
